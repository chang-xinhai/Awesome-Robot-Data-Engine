...
- [2026-08-08] Expanded **Simulation → Platforms / Frameworks** with a
  source-checked capability matrix covering PyBullet/Bullet, MuJoCo/MJX, Isaac
  Sim/Lab/Gym, SAPIEN/ManiSkill, Genesis, Gazebo, robosuite, SPEAR, Webots,
  CoppeliaSim, Brax, Drake, and practical data/label/licensing guidance.
...
| 2026-07-07 | Digital Teleoperation, World Model, 40+ FPS | Alibaba DAMO Academy | [RynnWorld-Teleop: An Action-Conditioned World Model for Digital Teleoperation](https://arxiv.org/abs/2607.06558) | arXiv | [project](https://alibaba-damo-academy.github.io/RynnWorld-Teleop.github.io/) / [github](https://github.com/alibaba-damo-academy/RynnWorld-Teleop) |
...
| 2026-06-15 | Multi-Arm Teleoperation, Agent Copilot, Demonstration Collection | Sun Yat-sen University | [HATS: A Human–Agent Teleoperation System for Multi-Arm Data Collection](https://arxiv.org/abs/2606.16491) | arXiv | — |
...
| 2026-03-15 | Humanoid Teleoperation, Whole-Body, Robustness Diagnostics | Beijing Institute of Technology | [OmniClone: Engineering a Robust, All-Rounder Whole-Body Humanoid Teleoperation System](https://arxiv.org/abs/2603.14327) | arXiv | [project](https://omniclone.github.io/) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-16 | Human Intervention, Timing Inconsistency, Distributional RL, Corrective Signals | Beijing Institute of Technology | [GAINS: Leveraging Inconsistent Human Intervention Signals in Reinforcement Learning](https://arxiv.org/abs/2608.15707) | arXiv | [project](https://gains-hil.github.io/) |
...
| 2026-01-27 | Human Intervention, Entropy Sampling, Sample Efficiency | Nanyang Technological University | [E2HiL: Entropy-Guided Sample Selection for Efficient Real-World Human-in-the-Loop Reinforcement Learning](https://arxiv.org/abs/2601.19969) | arXiv | [project](https://e2hil.github.io/) |
...
| 2026-05-25 | Episode Quality, Semantic Progress, Robot Telemetry, Operator Feedback | Siemens Corporation | [Closing the Loop in Teleoperation: Episode-Level Data Quality Assessment and Feedback for High-Quality Demonstration Collection](https://arxiv.org/abs/2605.26349) | arXiv | [paper](https://arxiv.org/abs/2605.26349) |
| 2026-02-15 | One Annotation, Generative Scene Augmentation, 35K Rollouts | Beijing Innovation Center of Humanoid Robotics | [RoboAug: One Annotation to Hundreds of Scenes via Region-Contrastive Data Augmentation for Robotic Manipulation](https://arxiv.org/abs/2602.14032) | arXiv | [project](https://x-roboaug.github.io/) |
| 2025-10-09 | Real-to-Real 3D Augmentation, Point Cloud + Action, One Demo | Tsinghua University | [R2RGen: Real-to-Real 3D Data Generation for Spatially Generalized Manipulation](https://arxiv.org/abs/2510.08547) | RSS 2026 | [project](https://r2rgen.github.io/) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-07-06 | Deformables, Multi-View Visuotactile, 215+ h | Brown University | [Deform360: A Massive Multi-view Visuotactile Dataset for Deformable World Models](https://arxiv.org/abs/2607.05390) | ECCV 2026 | [project](https://deform360.lhy.xyz/) |
| 2026-06-30 | Human-Aware Manipulation, 10K+ Episodes, 164 h | Config | [HABIT: Human-Aware Behavior and Interaction Training Dataset for Robot Manipulation](https://arxiv.org/abs/2606.31682) | arXiv | [project](https://habit-dataset.github.io/) |
| 2026-06-30 | Touch–Vision–Language, 122 Materials, DIGIT | ScaDS.AI, TU Dresden | [RCT: A Robot-Collected Touch–Vision–Language Dataset for Tactile Generalization](https://arxiv.org/abs/2606.31694) | arXiv | [project](https://faerber-lab.github.io/RCT/) / [github](https://github.com/faerber-lab/RCT) |
...
| 2025-09-29 | Mobile Manipulation, 25K+ Episodes, Failure Cases | University of Tokyo | [AIRoA MoMa Dataset: A Large-Scale Hierarchical Dataset for Mobile Manipulation](https://arxiv.org/abs/2509.25032) | arXiv | [dataset](https://huggingface.co/datasets/airoa-org/airoa-moma) |
...
| 2025 | ALOHA, Bimanual, 10,705 Episodes, 100+ Tasks, CC BY 4.0 | AIST | [AIST-Bimanual Manipulation Dataset](https://aistairc.github.io/aist_bimanip_site/) | Dataset | [downloads / visualizer](https://aistairc.github.io/aist_bimanip_site/) |
| 2024-03-28 | Primitive-Level Labels, 38K Clips, 67 Real-World Tasks | Shanghai AI Laboratory | [RH20T-P: A Primitive-Level Robotic Manipulation Dataset towards Composable Generalization Agents in Real-world Scenarios](https://arxiv.org/abs/2403.19622) | arXiv | [project / dataset](https://sites.google.com/view/rh20t-primitive/main) |
...
| 2019-11-11 | Remote Teleoperation, 111 h, 54 Users, Three Tasks | Stanford University | [Scaling Robot Supervision to Hundreds of Hours with RoboTurk: Robotic Manipulation Dataset through Human Reasoning and Dexterity](https://arxiv.org/abs/1911.04052) | arXiv | [project / dataset](https://roboturk.stanford.edu/realrobotdataset.html) |
| 2018-10-16 | Paired Human–Robot, 8,260 Demonstrations, 20 Tasks | Carnegie Mellon University | [Multiple Interactions Made Easy (MIME): Large Scale Demonstrations Data for Imitation](https://arxiv.org/abs/1810.07121) | CoRL 2018 | [project / dataset](https://sites.google.com/view/mimedataset) |

#### Multi-Embodiment / Aggregated Datasets

| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-18 | 5K Trajectories, 45 h, RGB-D+F/T+Tactile, 25 Industrial Tasks | Peking University | [PRISM: Precision and contact-rich Real-world Industrial Skill dataset with Multimodal sensing](https://arxiv.org/abs/2608.17962) | arXiv | [project / dataset](https://tengbo-yu.github.io/PRISM/) |
...
| 2025-02-28 | 23 OXE Sources, 12 Embodiments, Planning + Affordance + Trajectory Labels | Beijing Academy of Artificial Intelligence | [RoboBrain: A Unified Brain Model for Robotic Manipulation from Abstract to Concrete](https://arxiv.org/abs/2502.21257) | arXiv | [ShareRobot dataset](https://huggingface.co/datasets/BAAI/ShareRobot) |
...
| 2025-10-15 | Handheld UMI, GelSight Mini, Force Action Space | Technical University of Darmstadt | [Tactile-Conditioned Diffusion Policy for Force-Aware Robotic Manipulation](https://arxiv.org/abs/2510.13324) | arXiv | [project](https://tactile-farm.github.io/) |
...
| 2026-02-25 | World-Space, Joint Hand–Object, 4D Trajectory | Stanford University | [WHOLE: World-Grounded Hand-Object Lifted from Egocentric Videos](https://arxiv.org/abs/2602.22209) | arXiv | [project](https://judyye.github.io/whole-www) |
| 2026-02-04 | Monocular HOI, Sim-Ready Geometry, 6D Pose | Zhejiang University | [AGILE: Hand-Object Interaction Reconstruction from Video via Agentic Generation](https://arxiv.org/abs/2602.04672) | SIGGRAPH 2026 | [project](https://agile-hoi.github.io/) / [github](https://github.com/Chuan-10/AGILE) |
...
| 2025-12-19 | Human-to-Robot Video Translation, Video ICL, Automatic Paired Synthesis | National University of Singapore | [Mitty: Diffusion-based Human-to-Robot Video Generation](https://arxiv.org/abs/2512.17253) | arXiv | [github](https://github.com/showlab/Mitty) / [dataset](https://huggingface.co/datasets/showlab/Mitty_Dataset) |
...
| 2026-07-04 | Object-Aware, Contact-Preserving, Hand–Arm Retargeting | Sun Yat-sen University | [ObjRetarget: An Object-Aware Motion Retargeting Framework with Anthropomorphic Arm Constraints and Polyhedral Hand Modeling](https://arxiv.org/abs/2607.03828) | arXiv | [project](https://3469627147abc.github.io/ObjRetarget/) |
...
| 2026-06-15 | Interaction Graph, Contact Topology, Dexterous Retargeting | Tsinghua University | [TopoRetarget: Interaction-Preserving Retargeting for Dexterous Manipulation](https://arxiv.org/abs/2606.16272) | arXiv | [project](https://toporetarget2026.github.io/TopoRetarget/) |
...
| 2026-06-07 | Single Human Video, Digital Twin, Object-Centric Keyframes | Georgia Institute of Technology | [Video2Sim2Real: Full-Stack Autonomous Dexterous Skill Acquisition from a Single Human Video](https://arxiv.org/abs/2606.08828) | arXiv | [project](https://video2sim2real.github.io/) / [github](https://github.com/video2sim2real/video2sim2real) |
...
| 2026-05-07 | HOI Synthesis, Physics Grounding, Dexterous Actions | Korea Institute of Science and Technology | [DexSynRefine: Synthesizing and Refining Human-Object Interaction Motion for Physically Feasible Dexterous Robot Actions](https://arxiv.org/abs/2605.05925) | arXiv | [project](https://dexsynrefine.github.io/) |
...
| 2026-04-01 | Contact Force, VR Demonstration, Soft-Hand Retargeting | Carnegie Mellon University | [Functional Force-Aware Retargeting from Virtual Human Demos to Soft Robot Policies](https://arxiv.org/abs/2604.01224) | arXiv | [project](https://soft-act.github.io/) |
...
| 2025-12-02 | HOI Reconstruction, Physics Refinement, Cross-Embodiment | Tsinghua University | [RoboWheel: A Data Engine from Real-World Human Demonstrations for Cross-Embodiment Robotic Learning](https://arxiv.org/abs/2512.02729) | arXiv | [project](https://zhangyuhong01.github.io/Robowheel) / [github](https://github.com/zhangyuhong01/Robowheel-Toolkits) / [dataset](https://huggingface.co/datasets/HORA-DB/HORA) |
...
| 2025-11-12 | Physics-Informed Retargeting, 9 Embodiments, 6 Datasets, 2.4M Frames | Meta FAIR | [SPIDER: Scalable Physics-Informed Dexterous Retargeting](https://arxiv.org/abs/2511.09484) | arXiv | [project](https://jc-bao.github.io/spider/) |
...
| 2025-09-30 | Interaction Mesh, Humanoid Whole-Body, Contact-Preserving Augmentation | Amazon FAR | [OmniRetarget: Interaction-Preserving Data Generation for Humanoid Whole-Body Loco-Manipulation and Scene Interaction](https://arxiv.org/abs/2509.26633) | arXiv | [project](https://omniretarget.github.io/) |
...
| 2025-12-15 | Finger-Keypoint Actions, Dexterous World Model, 900 h Human + Robot Video | Meta FAIR | [World Models for Learning Dexterous Hand-Object Interactions from Human Videos](https://arxiv.org/abs/2512.13644) | arXiv | [project](https://raktimgg.github.io/dexwm/) / [github](https://github.com/facebookresearch/dexwm) |
...
| 2025-12-04 | Human-to-Humanoid Video, 17+ h Paired Synthetic, 3.6M Frames | National University of Singapore | [X-Humanoid: Robotize Human Videos to Generate Humanoid Videos at Scale](https://arxiv.org/abs/2512.04537) | arXiv | [project](https://showlab.github.io/X-Humanoid/) |
| 2025-10-17 | 7,000 h, RGB-D + MANO + Contact Force, Hybrid Real–Synthetic | DexRobot | [DexCanvas: Bridging Human Demonstrations and Robot Learning for Dexterous Manipulation](https://arxiv.org/abs/2510.15786) | arXiv | [github](https://github.com/dexrobot/dexcanvas) / [dataset](https://huggingface.co/datasets/DEXROBOT/DexCanvas) |
...
| 2025-03-07 | 11,664 Actions, Assembly, Pressure + Audio + MoCap + Gaze + EMG | Tongji University | [Kaiwu: A Multimodal Manipulation Dataset and Framework for Robot Learning and Human-Robot Interaction](https://arxiv.org/abs/2503.05231) | IEEE RA-L 2025 | [project / dataset](https://kaiwudataset.github.io/) |
...
| 2026-04-30 | On-Device XR Physics, Human Retargeting, Physics-Guided Video Synthesis | MIT CSAIL | [Lucid-XR: An Extended-Reality Data Engine for Robotic Manipulation](https://arxiv.org/abs/2605.00244) | arXiv | [project](https://lucidxr.github.io/) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-09-10 | LTLf-Guided Demonstrations, Multi-Agent Coordination, Diffusion Policy | University of Toronto | [LTLDiff: Finite Linear Temporal Logic-Guided Data Generation and Diffusion Policies for Multi-agent Robotic Manipulation](https://arxiv.org/abs/2609.11043) | arXiv | [paper](https://arxiv.org/abs/2609.11043) |
...
| 2026-04-14 | GPU Trajectory Optimization, Whole-Body Mobile Manipulation, 500K | Peking University | [Scalable Trajectory Generation for Whole-Body Mobile Manipulation](https://arxiv.org/abs/2604.12565) | CVPR 2026 Highlight | [project](https://automoma.pages.dev/) / [github](https://github.com/fi6/automoma/) / [dataset](https://huggingface.co/datasets/automoma/automoma-500k/tree/traj-500k) |
...
| 2025-11-24 | Diverse RL Rollouts, Behavior Discovery, VLA Pretraining | HKUST | [Discover, Learn, and Reinforce: Scaling Vision-Language-Action Pretraining with Diverse RL-Generated Trajectories](https://arxiv.org/abs/2511.19528) | arXiv | — |
...
| 2025-08-05 | One Expert Trajectory, Geometry + Pose Variation, Constraint-Preserving | UT Austin | [Constraint-Preserving Data Generation for Visuomotor Policy Learning](https://arxiv.org/abs/2508.03944) | CoRL 2025 | [project](https://cp-gen.github.io/) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-27 | Cross-Embodiment Video Simulator, Human + Robot Video, EE / Language / Latent Actions | Princeton University | [CLAP: Cross-Embodiment Video World Models are Zero-Shot Physical Simulators](https://arxiv.org/abs/2608.27406) | arXiv | [project](https://omni-clap.github.io/) / [github](https://github.com/omni-CLAP/clap) |
| 2026-07-31 | Action-Conditioned Video Simulator, Synthetic Rollouts, Policy Evaluation | Boundless Large Model Lab | [BWM: A Low-Cost High-Fidelity World Simulator for Robot Learning](https://arxiv.org/abs/2607.29302) | arXiv | [github](https://github.com/boundless-large-model/boundless-world-model) / [model](https://huggingface.co/BLM-Lab/Boundless-World-Model) |
...
| 2026-05-20 | Geometry-Enhanced Video Rollouts, Dense 4D Correspondence, Inverse Dynamics | Harvard University | [GEM-4D: Geometry-Enhanced Video World Models for Robot Manipulation](https://arxiv.org/abs/2605.22882) | arXiv | [project](https://gem-4d.github.io/) |
...
| 2026-01-26 | Generated Video-to-Action, Tool-Centric 3D Motion, Cross-End-Effector | Beijing Innovation Center of Humanoid Robotics | [TC-IDM: Grounding Video Generation for Executable Zero-shot Robot Motion](https://arxiv.org/abs/2601.18323) | arXiv | [project](https://wsbaiyi.github.io/TC-IDM-Page/) / [github](https://github.com/wsbaiyi/TC-IDM) |
| 2025-12-12 | Embodiment-Anchored Video Diffusion, Few Demonstrations, Synthetic Rollouts | USC Physical Superintelligence Lab | [AnchorDream: Repurposing Video Diffusion for Embodiment-Aware Robot Data Synthesis](https://arxiv.org/abs/2512.11797) | arXiv | [project](https://jay-ye.github.io/AnchorDream/) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-05 | Single Static Video, 3DGS + Mesh, Suggested Articulation, Isaac Sim / Unreal | Seoul National University | [RORA: Realistic Object Reconstruction with Articulation](https://arxiv.org/abs/2608.04842) | arXiv | — |
...
| 2026-01-26 | AirExo-3, 4D Gaussian Splatting, Real-to-Sim-to-Real | Shanghai Jiao Tong University | [ExoGS: A 4D Real-to-Sim-to-Real Framework for Scalable Manipulation Data Collection](https://arxiv.org/abs/2601.18629) | arXiv | [github](https://github.com/zaixiabalala/ExoGS) |
| 2025-10-17 | 3DGS + Vectorized Physics, 100K+ Steps/s, Pixel-Based Sim-to-Real | UC Berkeley | [GaussGym: An open-source real-to-sim framework for learning locomotion from pixels](https://arxiv.org/abs/2510.15352) | arXiv | [project](https://gauss-gym.com/) |
...
The following matrix is a practical starting point for building a simulator-backed
data engine. It separates the physics backend from the data-generation layer:
rendering and sensor fidelity, vectorized stepping, asset/task authoring, and
dataset export should be reported independently when comparing platforms. Claims
below are limited to capabilities documented by the linked official project or
documentation (access and asset licenses can still differ by release and asset).

| Platform | Physics / scale | Rendering and sensors | Robots, assets, and data workflow | Access / licensing notes |
| :--- | :--- | :--- | :--- | :--- |
| [NVIDIA Isaac Sim](https://developer.nvidia.com/isaac/sim) | PhysX-based rigid/articulated and deformable simulation; USD/Omniverse scene graph; GPU execution for large batched scenes | RTX renderer; RGB/depth/segmentation cameras, 2D LiDAR, IMU, contact and other sensor extensions; Replicator provides annotators, writers, and domain randomization | Import CAD, URDF, USD, and real-world captures; ROS 2, SIL/HIL, action/event/grasp/teleoperation SDG workflows | NVIDIA Omniverse application; Isaac Sim components and third-party assets retain their own terms—check the release license before redistribution |
| [Isaac Lab](https://github.com/isaac-sim/IsaacLab) | Open-source robot-learning layer on Isaac Sim; GPU-parallel environments for RL, IL, motion planning, rigid/deformable bodies | RTX RGB/depth/segmentation, camera annotations, IMU, contact sensors, ray casters; headless/cloud scaling | 16+ robot models and 30+ task environments; manager/direct workflows, domain randomization, demonstrations, and policy rollouts | Framework BSD-3-Clause (Apache-2.0 for `isaaclab_mimic`); full PhysX/RTX/ROS/URDF/MJCF workflow requires Isaac Sim, whose dependencies have separate terms |
| [MuJoCo](https://github.com/google-deepmind/mujoco) + [MJX](https://mujoco.readthedocs.io/en/stable/mjx.html) | Fast articulated rigid-body contact dynamics; MJX reimplements the model in JAX for accelerator/vectorized rollouts; differentiable-physics utilities | Native OpenGL viewer and offscreen rendering; RGB/depth/segmentation plus state, contact, force, and sensor channels | Human-readable MJCF (plus URDF import); Python/C APIs, `dm_control`, procedural model editing, batched rollouts | Core source Apache-2.0; released binaries and Python wheels target Linux/Windows/macOS |
| [SAPIEN 3](https://github.com/haosulab/SAPIEN) | PhysX 5, including GPU simulation; physics-rich articulated-part interaction and contacts | Vulkan/Sapien renderer with ray tracing; GPU stereo-depth simulation, offscreen/render-server operation, camera/point-cloud support | PartNet-Mobility articulated objects, URDF and procedural builders; strong fit for interaction, grasping, and part-level labels | PyPI package; Linux GPU is the primary supported path. Repository contains the engine license; PartNet-Mobility/other assets have separate terms |
| [ManiSkill 3](https://github.com/mani-skill/ManiSkill) | GPU-parallel SAPIEN environments for manipulation; vectorized rigid-body stepping and sim-to-real baselines | SAPIEN raster/ray-traced cameras, RGB-D/segmentation and state observations | Procedural task generation, demonstrations, RL/IL/VLA baselines, AI2-THOR/ReplicaCAD scenes; supports Colab CPU/GPU variants | Open-source framework; rigid environments use permissive licenses, while bundled assets are CC BY-NC 4.0 |
| [PyBullet / Bullet](https://github.com/bulletphysics/bullet3) | Real-time rigid-body and collision dynamics; CPU-friendly and easy to run across Linux, macOS, and Windows | OpenGL or TinyRenderer; camera RGB/depth/segmentation, ray tests, contact/force and full simulator state | Python API loads URDF, SDF, MJCF and other models; inverse/forward dynamics and kinematics make it useful for scripted rollouts and dataset prototypes | Bullet/PyBullet uses the zlib/libpng-style license; visual quality and large-scale GPU throughput are lower than Isaac/MJX stacks |
| [Genesis World](https://github.com/Genesis-Embodied-AI/genesis-world) | Unified multi-physics scene (rigid, FEM, MPM, SPH, PBD, IPC/SAP) with a cross-platform compiler for CUDA, ROCm, Metal, Vulkan, x86, and ARM | Nyx, Luisa, and PyRender camera paths; documented depth, IMU, LiDAR, tactile, contact-force, and PBR workflows | URDF/MJCF/OBJ/GLB/USD ingestion, heterogeneous/parallel environments, controllers, domain randomization, and differentiable kernels | Open-source project; solver, renderer, optional backends, and external assets may carry separate licenses—pin a commit for reproducibility |
| [Gazebo Sim (Harmonic/Jetty)](https://github.com/gazebosim/gz-sim) | Plugin-selectable physics through Gazebo Physics; server/GUI separation and asynchronous transport | OGRE2/PBR rendering; 2D/3D cameras, depth, LiDAR, IMU, GPS, force-torque, contact and noise models | SDF world/model format, Gazebo Fuel assets, ROS 2 bridge, plugins and remote TCP/IP control; strong for ROS-integrated logs and replay | Open-source Gazebo stack; use an LTS release and record Gazebo/ROS 2 versions in dataset metadata |
| [robosuite](https://github.com/ARISE-Initiative/robosuite) | MuJoCo-backed articulated manipulation; reproducible benchmark tasks and configurable controllers | RGB/depth cameras, proprioception and low-level physical state; optional photorealistic rendering | Procedural robot/arena/object composition, keyboard/SpaceMouse/viewer teleoperation, human demonstration recording and replay | Open-source research framework; robot/object assets and external rendering dependencies remain separately licensed |
| [RoboHive](https://github.com/vikashplus/robohive) | MuJoCo environments for manipulation, locomotion, dexterity, and musculoskeletal/biomechanics tasks | MuJoCo visual and state observations, with standardized Gym-style interfaces | Unified environment registry, demonstrations, task randomization, and hardware-interface-oriented APIs | Research code and bundled environments should be checked per repository release |
| [Brax](https://github.com/google/brax) / [MuJoCo Playground](https://github.com/google-deepmind/mujoco_playground) | JAX accelerator pipelines for massively parallel rigid-body rollouts; Playground is the actively maintained MuJoCo-based robot-learning stack | Brax is primarily a physics/training backend; Playground adds batch rendering and robot sensor observations | JAX/PyTorch training loops, PPO/SAC and sim-to-real examples; use MJX/Playground for new MuJoCo accelerator work rather than legacy Brax envs | Brax Apache-2.0; Playground and its model/asset repositories have their own terms |
| [SPEAR](https://github.com/spear-sim/spear) | Unreal Engine control layer rather than a standalone rigid-body engine; optional deterministic co-simulation with MuJoCo | Photorealistic UE camera at 1920×1080 and 73 FPS; depth, normals, instance/semantic IDs, intrinsic decomposition, material IDs, and shading parameters | Python can control any UE application through 14K+ reflected functions; procedural content generation, multi-agent actions, synchronized multi-view capture, and NumPy output | Code MIT and released assets CC0 according to the official repository; UE sample projects and third-party content retain Epic/asset terms |
| [Webots](https://github.com/cyberbotics/webots) | Cross-platform open-source robot simulator with ODE-based rigid-body dynamics and deterministic controller stepping | Camera, depth, LiDAR/radar, GPS, IMU/accelerometer/gyro, touch/proximity and other actuator/sensor models | WBT/PROTO worlds, robot/vehicle libraries, Python/C++/Java/MATLAB/ROS 2 controllers, webots.cloud examples | Apache-2.0 project; models/worlds can include separate attribution or asset terms |
| [CoppeliaSim](https://coppeliarobotics.com/) | Distributed-control simulator with selectable MuJoCo, Bullet, ODE, Vortex, or Newton dynamics plus FK/IK | Vision sensors and image processing; proximity/volumetric sensors, point clouds, and custom sensor plugins | Scene composition, embedded/remote API, ROS/ROS 2, ZeroMQ, Lua/Python/C++/MATLAB; useful for digital twins and multi-robot logging | Edu edition is restricted to schools; Pro/commercial editions are separately licensed—do not assume repository-style open source |
| [Drake](https://github.com/RobotLocomotion/drake) | High-fidelity multibody plant, contact, hydroelastic geometry, and optimization/control rather than a turnkey dataset simulator | SceneGraph/RenderEngine RGB-D and depth/label outputs; sensors integrate with systems diagrams | URDF, SDFormat, MJCF import; planning, system identification, trajectory optimization, and reproducible state/action logs | Open-source Drake; imported models and renderer dependencies have independent terms |

For quick selection: use **PyBullet/MuJoCo** for lightweight, inspectable physics;
**Isaac Sim + Isaac Lab, SAPIEN + ManiSkill, or Genesis** for GPU-parallel
robot-learning and scalable rollouts; **Gazebo/Webots/CoppeliaSim** when ROS,
multi-robot integration, or teaching-oriented sensor stacks dominate; and
**SPEAR** when UE photorealism, arbitrary scene programmability, or a
MuJoCo–rendering co-simulation is the main data requirement. For a publishable
dataset, log simulator version, physics backend, renderer, asset/license IDs,
randomization seed, sensor intrinsics/extrinsics, and whether labels are
privileged state or rendered observations.

| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-25 | Generative Surgical Simulator, ~160 FPS, Live Human / Policy Control | NVIDIA | [NVIDIA Cosmos-H-Dreams: Real-Time Generative Physics Simulation for Surgical Robotics](https://arxiv.org/abs/2608.24199) | arXiv | [github](https://github.com/isaac-for-healthcare/Cosmos-H-Dreams) |
| 2026-08-25 | Batched GPU Surgical Simulation, Deformables + Fluids + Ultrasound, DLPack | University of Alberta | [CRESSim-Neo: A Batched GPU Simulation Engine for Surgical Robotics and Robot Learning](https://arxiv.org/abs/2608.25192) | arXiv | [project](https://tbs-ualberta.github.io/CRESSim/) |
| 2026-07-07 | Unreal Engine, Photorealistic SDG, MuJoCo Co-simulation | Adobe Research | [SPEAR: A Simulator for Photorealistic Embodied AI Research](https://arxiv.org/abs/2607.06701) | ECCV 2026 Spotlight Oral | [project / code](https://mikeroberts3000.github.io/papers/spear/) / [github](https://github.com/spear-sim/spear) |
| 2026-06-02 | Isaac Sim, GPU Simulation, Synthetic Data Survey | NVIDIA | [NVIDIA Isaac Sim: Enabling Scalable, GPU-Accelerated Simulation for Robotics](https://arxiv.org/abs/2606.03551) | arXiv | [official docs](https://developer.nvidia.com/isaac/sim) |
| 2026-05-24 | MuJoCo, Persistent Batching, Runtime Infrastructure | — | [MuJoCoUni: Persistent Batched Runtime Primitives for MuJoCo](https://arxiv.org/abs/2605.24922) | Technical report | [project](https://github.com/google-deepmind/mujoco) |
| 2025-11-06 | Isaac Sim, GPU Parallelism, Multi-Modal Robot Learning | NVIDIA | [Isaac Lab: A GPU-Accelerated Simulation Framework for Multi-Modal Robot Learning](https://arxiv.org/abs/2511.04831) | Technical report | [github / docs](https://github.com/isaac-sim/IsaacLab) |
...
| 2021-08-24 | PhysX, GPU Rollouts, Reinforcement Learning | NVIDIA | [Isaac Gym: High Performance GPU-Based Physics Simulation For Robot Learning](https://arxiv.org/abs/2108.10470) | arXiv | [developer page](https://developer.nvidia.com/isaac-gym) |
...
| Date | Keywords | Institute (first) | Paper | Publication | Others |
| :--: | :------: | :---------------: | :---: | :---------: | :----: |
| 2026-08-26 | Camera-Centric Action Geometry, 9 Embodiments, Robot + Sim + Human Data | Xiaomi Robotics / University of Macau | [One Policy, Many Embodiments: Unified Camera-Centric Action Geometry Pre-training for Heterogeneous Embodied Manipulation](https://arxiv.org/abs/2608.26058) | arXiv | — |
| 2026-08-18 | Action Flow, Cross-Embodiment Interface, Human-to-Robot, World-Model Evaluation | NVIDIA | [Hydra-0: Action Flow for Generalist World Modeling and Control](https://arxiv.org/abs/2608.18077) | arXiv | [project](https://nvidia-isaac.github.io/video_to_data/hydra-0/) |
...
| 2025-11-26 | 3D Trace-Space, Cross-Embodiment Video, 123K Videos / 1.8M Triplets | University of Maryland, College Park | [TraceGen: World Modeling in 3D Trace Space Enables Learning from Cross-Embodiment Videos](https://arxiv.org/abs/2511.21690) | CVPR 2026 | [project / code / dataset](https://tracegen.github.io/) |
...
| 2024-04-26 | Agent-Agnostic Visual + Action Representation, Human Video, Cross-Embodiment | Beijing Institute for General Artificial Intelligence | [Ag2Manip: Learning Novel Manipulation Skills with Agent-Agnostic Visual and Action Representations](https://arxiv.org/abs/2404.17521) | IROS 2024 | [project](https://xiaoyao-li.github.io/research/ag2manip/) / [github](https://github.com/xiaoyao-li/Ag2Manip) |
...
| 2026-02-18 | Agentic Task Curation, Physical Feasibility, 18K Real Trajectories | Beijing Innovation Center of Humanoid Robotics | [RoboGene: Boosting VLA Pre-training via Diversity-Driven Agentic Framework for Real-World Task Generation](https://arxiv.org/abs/2602.16444) | arXiv | [project](https://robogene-boost-vla.github.io/) |
| 2026-02-11 | UniACT Standardization, 6M+ Trajectories, 9,500 h | AMAP CV Lab, Alibaba Group | [ABot-M0: VLA Foundation Model for Robotic Manipulation with Action Manifold Learning](https://arxiv.org/abs/2602.11236) | arXiv | [project](https://amap-cvlab.github.io/ABot-Manipulation/) / [github](https://github.com/amap-cvlab/ABot-Manipulation) |
| 2026-01-31 | DataQA, Temporal Alignment + Filtering, 3,000 h, Unified Actions | Sber Robotics Center | [Green-VLA: Staged Vision-Language-Action Model for Generalist Robots](https://arxiv.org/abs/2602.00919) | arXiv | [project](https://greenvla.github.io/) / [github](https://github.com/greenvla/GreenVLA) |
| 2025-11-03 | Pixel-160K, 6.5M Image–Text–Action Triplets, Automated Annotation | University of Trento | [PixelVLA: Advancing Pixel-level Understanding in Vision-Language-Action Model](https://arxiv.org/abs/2511.01571) | ICLR 2026 | [project](https://wenqiliang.github.io/PixelVLA/) |
...
| 2025-05-04 | OXE Instruction Conversion, Interleaved Image–Text, 210K Episodes | Shanghai Jiao Tong University | [Interleave-VLA: Enhancing Robot Manipulation with Interleaved Image-Text Instructions](https://arxiv.org/abs/2505.02152) | ICLR 2026 | [github / dataset](https://github.com/Interleave-VLA/Interleave-VLA) |
...
| 2023-11-01 | Human + Robot Collection, 829K Video–Text Pairs, 29.5K Instructions | Google DeepMind | [RoboVQA: Multimodal Long-Horizon Reasoning for Robotics](https://arxiv.org/abs/2311.00899) | arXiv | [project / dataset](https://robovqa.github.io/) |
...
| 2026-02-12 | RoboOrchard, Data Curation–Training–Deployment, Artifact Interfaces | Horizon Robotics | [HoloBrain-0 Technical Report](https://arxiv.org/abs/2602.12062) | arXiv | [project](https://horizonrobotics.github.io/robot_lab/holobrain/) / [github](https://github.com/HorizonRobotics/RoboOrchardLab) / [real-robot stack](https://github.com/HorizonRobotics/RoboOrchard) |
...
| 2026 | Multi-Node VLA Training, WebDataset Streaming, Dataset Mixing + Balancing | Toyota Research Institute | [VLA Foundry: A Unified Framework for Training Vision-Language-Action Models](https://github.com/TRI-ML/vla_foundry) | GitHub | [docs](https://tri-ml.github.io/vla_foundry/) |
...
| 2024-08-20 | ARIO Standard, 3M Episodes, 258 Series, 321K Tasks | Peng Cheng Laboratory | [All Robots in One: A New Standard and Unified Dataset for Versatile, General-Purpose Embodied Agents](https://arxiv.org/abs/2408.10899) | arXiv | [project / standard / dataset](https://ario-dataset.github.io/) |
...
| 2025-05-12 | Factored Scaling Curves, Data Allocation, Collection Budget | Princeton University | [Guiding Data Collection via Factored Scaling Curves](https://arxiv.org/abs/2505.07728) | arXiv | [project](https://factored-data-scaling.github.io/) |
...
| 2026-08-18 | Safety Specifications, 1K Scenarios, 8K Annotated Demos, LTLf Monitoring | Northwestern University | [MANIGUARD: A Benchmark and Data Suite for Specification-Grounded Safety Evaluation and Improvement of Robotic Manipulation](https://arxiv.org/abs/2608.17386) | arXiv | [project](https://nu-ideas-lab.github.io/ManiGuard/) / [github](https://github.com/NU-IDEAS-Lab/ManiGuard) |
| 2026-08-13 | Human-to-Robot Video Generation, Five Diagnostic Dimensions, 11 Models | Shanghai Jiao Tong University | [H2R-Bench: Benchmarking Human-to-Robot Manipulation Video Generation in World Models](https://arxiv.org/abs/2608.13049) | arXiv | — |
| 2026-08-12 | Synthetic Data Challenge, Physical Evaluation, Sim-to-Real Generalization | Shenzhen Loop Area Institute | [RoboSynChallenge: Mastering Real-World Dexterity via Generalizing Synthesized Manipulation Skills](https://arxiv.org/abs/2608.12416) | NeurIPS 2026 Competition Track | [benchmark](https://robosyn-bench.net/) / [github](https://github.com/EDEM-AI/RoboSynChallenge) |
| 2026-08-12 | Human-to-Robot Editing, 200M Instances, 26 URDFs, Two Evaluation Tracks | Shanghai Jiao Tong University | [HandEdit: A Unified Benchmark for Egocentric Human-to-Robot Dexterous Hand Image Editing](https://arxiv.org/abs/2608.12122) | Technical Report | [project](https://handedit.github.io/) / [github](https://github.com/HandEdit/HandEdit) |
...
| 2026-07-10 | Whole-Hand Tactile, Human-to-Robot, Contact Benchmark | ShanghaiTech University | [TactiDex: A Real-World Tactile-Guided Benchmark for Human-Like Dexterous Manipulation](https://arxiv.org/abs/2607.09190) | arXiv | [project](https://tactidex.github.io/) |
...
| 2026-05-26 | Continual VLA, Real-Robot Sequential Tasks, Forgetting + Replay | University of Hong Kong | [Can Vision-Language-Action Models Learn from Real-World Data Continually without Forgetting?](https://arxiv.org/abs/2605.26820) | arXiv | — |
