...
- 2026-08-17 — [Exposing the Long-tail in Embodied Urban Navigation via Scalable Learning from In-the-Wild Videos](https://arxiv.org/abs/2608.16476)
- 2026-08-16 — [Pre-training Visual Dexterity in Simulation](https://arxiv.org/abs/2608.15917)
- 2026-08-16 — [EgoGazeLite: On-Device Egocentric Gaze Prediction for Token-Efficient Multimodal LLM Video Input](https://arxiv.org/abs/2608.15614)
- 2026-08-16 — [AlloEgo-VLM: Disambiguating Allocentric and Egocentric Reference Frames in Vision-Language Models](https://arxiv.org/abs/2608.15605)
...
- 2026-08-17 — [Planner-Conditioned Diffusion for Coordinated Multi-Agent Exploration](https://arxiv.org/abs/2608.16229)
- 2026-08-17 — [Digital Twin Degradation: Detecting Cyber Physical Attacks via Temporal Inconsistencies](https://arxiv.org/abs/2608.16159)
- 2026-08-16 — [Pre-training Visual Dexterity in Simulation](https://arxiv.org/abs/2608.15917)
